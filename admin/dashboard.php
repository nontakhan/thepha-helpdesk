...
<div class="row mb-4">
    <div class="col-md-4">
        <div class="card text-white bg-warning mb-3">
            <div class="card-body">
                <h5 class="card-title">รอรับเรื่อง</h5>
                <p class="card-text fs-2"><?php echo $pending_count; ?> รายการ</p>
            </div>
            <div class="card-footer text-center"><a href="requests_list.php?status=1" class="text-white">ดูทั้งหมด <i
                        class="bi bi-arrow-right-circle"></i></a></div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card text-white bg-info mb-3">
            <div class="card-body">
                ...
                <p class="card-text fs-2"><?php echo $processing_count; ?> รายการ</p>
            </div>
            <div class="card-footer text-center"><a href="requests_list.php?status=2" class="text-white">ดูทั้งหมด <i
                        class="bi bi-arrow-right-circle"></i></a></div>
        </div>
    </div>
    <div class="col-md-4">
        <div class="card text-white bg-success mb-3">
            <div class="card-body">
                <h5 class="card-title">งานที่เสร็จสิ้น (เดือนนี้)</h5>
                <p class="card-text fs-2"><?php echo $completed_count_month; ?> รายการ</p>
            </div>
            <div class="card-footer text-center"><a href="report.php" class="text-white">ไปที่หน้ารายงาน <i
                        class="bi bi-arrow-right-circle"></i></a></div>
        </div>
    </div>
</div>
...
<div class="row">
    ...
    <div class="col-lg-6 mb-4">
        <div class="card">
            <div class="card-header">
                <h5 class="card-title mb-0">สรุปผลการทำงาน (SLA)</h5>
            </div>
            <div class="card-body" style="height: 300px;">
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        axios.get('../api/get_chart_data.php')
            .then(function (response) {
                ...
                // --- 3. สร้างกราฟวงกลม (SLA) พร้อมแสดง % ---
                new Chart(document.getElementById('slaPerformanceChart'), {
                    type: 'pie',
                    data: {
                        labels: chartData.slaPerformance.labels,
                        datasets: [{
                            label: 'จำนวนเรื่อง',
                            data: chartData.slaPerformance.data,
